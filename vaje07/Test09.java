...
public class Test09 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(os11.jeOcetovskiPrednikOd(os41));
        System.out.println(os23.jeOcetovskiPrednikOd(os42));
        System.out.println(os13.jeOcetovskiPrednikOd(os45));
        System.out.println(os14.jeOcetovskiPrednikOd(os45));
        System.out.println(os15.jeOcetovskiPrednikOd(os14));
        System.out.println(os15.jeOcetovskiPrednikOd(os15));
    }
}
